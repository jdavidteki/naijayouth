  ...
  createUserProfile = (profile) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      set({
        ...
        dateJoined: today,
        avatar: `https://firebasestorage.googleapis.com/v0/b/naijayouth-ff8d1.appspot.com/o/images%2F${profile.uid}.jpeg?alt=media&token=86d4ac39-d703-416a-a257-f209a64b0cb4`
      }).
      then(() => {
        resolve(true)
      }).catch(error =>{
